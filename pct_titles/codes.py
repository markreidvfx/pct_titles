...
0x03 : ['lock', b'>h',],
0x04 : ['bbox', b'>hhhh',],
0x05 : ['fill_color', b'>HHH',],
0x06 : ['border_color', b'>HHH',],
0x07 : ['shadow_color', b'>HHH',],
0x08 : ['fill_alpha', b'>H',],
0x09 : ['border_alpha', b'>H',],
0x0A : ['shadow_alpha', b'>H',],
0x0B : ['line_width', b'>H',],
0x0C : ['shadow_mode', b'>H',],
0x0D : ['shadow_depth', b'>H',],
0x0F : ['bbox', b'>hhhh',],
0x10 : ['arrow_type', b'>H',],
0x11 : ['arrow_desc', b'>hhhhhhhh',],
0x19 : ['corner_roundness', b'>H',],
0x24 : ['justify', b'>H',],
0x25 : ['global_kerning', b'>h',],
0x26 : ['video_bg', b'>H',],
0x27 : ['bg_color', b'>HHH',],
0x2A : ['??', b'>H',],
0x2B : ['color1', b'>HHH',],
0x2C : ['??', b'>H',],
0x2D : ['??', b'>H',],
0x2E : ['fill_gradient_end_transparencey', b'>H',],
0x2F : ['fill_gradient_dir', b'>H',],
0x30 : ['??', b'>H',],
0x31 : ['color2', b'>HHH',],
0x32 : ['??', b'>H',],
0x33 : ['??', b'>H',],
0x34 : ['border_gradient_end_transparencey', b'>H',],
0x35 : ['border_gradiant_dir', b'>H',],
0x3B : ['text_formating', -1],
0x3F : ['border_width', b'>H',],
0x40 : ['leading', b'>h',],
0x41 : ['kerning_data', -1,],
0x4A : ['shadow_blur', b'>H',],
0x0E : ['shadow_dir', b'>hh', ],
0x3C : ['font_list', -1,] ,
0x42 : ['??', b'>I'],
}
